...
class EEGDriver:
    ...
    def get_band_powers(self) -> dict:
        ...
        if data.shape[1] < 256:
            return {"alpha_relaxation": 0.0, "beta_cognitive_load": 0.0, "gamma_binding": 0.0}
        ...
        for channel in self.eeg_channels:
            ...
            DataFilter.perform_bandpass(data[channel], self.sampling_rate, 1.0, 50.0, 4, FilterTypes.BUTTERWORTH.value, 0)
