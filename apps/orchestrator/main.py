...
class T3l3pathyOrchestrator:
    ...
    async def runtime_loop(self):
        ...
        print("[T3L3PATHY] Core online. Streaming multimodal context to Gemini 3.1 Pro...")
        ...
        while self.is_running:
            ...
            frame["s3lf_c0n8ious"] = self.s3lf_c0n8ious.evaluate_state(frame, self.last_confidence)
            ...
            try:
                ...
                print(f"[GEMINI] {response.text[:100]}...") # Print first 100 chars of output
